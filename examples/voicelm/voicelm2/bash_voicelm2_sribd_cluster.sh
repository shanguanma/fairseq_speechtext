...
#  /mntcephfs/lab_data/maduo/datasets/format/librispeech/40M_librispeech_lm_monophncode_librispeech_frame_monophncode_using_wav2vec-u2_model_with_text_ratio10_iter1_voicelm2_12layer_500_kms/
...
## note: text_ratio=10 voicelm2
if [ ${stage} -le 70 ] && [ ${stop_stage} -ge 70 ];then
   echo "iter2: pretrain voicelm2 on librilm monophncode and librispeech monophncode from w2vu2-model "
   echo "training on 400k steps for train-960 of librispeech"
   fairseq_dir=/mntnfs/lee_data1/maduo/codebase/fairseq_speechtext
   tsv_dir=/mntcephfs/lab_data/maduo/datasets/format/librispeech/
   dir=/mntnfs/lee_data1/maduo/exp
   label_dir=$tsv_dir/40M_librispeech_lm_monophncode_librispeech_frame_monophncode_using_wav2vec-u2_model_with_text_ratio10_iter1_voicelm2_12layer_500_kms/
   #label_dir=$tsv_dir/librispeech_lm_monophncode_using_monophn_dict_librispeech_frame_monophncode_using_wav2vec-u2_model

   config_dir=$fairseq_dir/examples/voicelm/voicelm2
   #model_name=pretrain_on_base_voicelm2_4gpu_8update_960h_400k_update_flash_attention_lr4e_4_40M_unpaired_text_ratio10_bs2400k_max_phone250
   model_name=pretrain_on_base_voicelm2_4gpu_8update_960h_400k_update_flash_attention_lr4e_4_40M_unpaired_text_ratio10_bs3400k_max_phone300_iter1_voicelm2_12layer_500_kms
   #model_name=pretrain_on_base_voicelm2_2gpu_16update_960h_400k_update_flash_attention_debug
   exp_dir=$dir/pretrain/${model_name}
   mkdir -p $exp_dir
   world_size=4
...
if [ ${stage} -le 71 ] && [ ${stop_stage} -ge 71 ];then
   echo "iter2: finetune voicelm2 on train-clean-100 on 80k steps in letter ctc loss mode"
   echo "with freeze feature_fuse layer and text_drop false in finetune mode"
   fairseq_dir=/mntnfs/lee_data1/maduo/codebase/fairseq_speechtext
   tsv_dir=/mntcephfs/lab_data/maduo/datasets/format/librispeech/
   dir=/mntnfs/lee_data1/maduo/exp
