...
## e.g.: ## only specify partition, specify 4 gpus, and 24 cpus
## sbatch --nodes 1  --gres=gpu:4  --cpus-per-gpu=6  --ntasks-per-node 1  -p p-V100 -o logs/data2vec2_stage0_pretrain.log   data2vec2_for_slurm.sh --stage 0 --stop-stage 0

## speciy node and specify partition specify 4 gpus, and 24 cpus
#sbatch --nodes 1  --gres=gpu:4  --cpus-per-gpu=6  --ntasks-per-node 1  --nodelist=pgpu17 -p p-A100 -o logs/data2vec2_stage0_pretrain.log   data2vec2_for_slurm.sh --stage 0 --stop-stage 0
###
