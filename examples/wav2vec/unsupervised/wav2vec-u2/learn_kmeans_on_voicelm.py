...
logger = logging.getLogger('learn_kmeans_on_voicelm')

def get_parser():
    parser = argparse.ArgumentParser()
    parser.add_argument("--feats",type=str, help="store iter1 speciy layer feature of trained voicelm")
...
def load_voicelm_feature(feats):
    ...
    logger.info(f"Loading voicelm featuree from npy file succcessfully, feats shape: {feats.shape}")
