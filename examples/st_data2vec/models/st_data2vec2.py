...
from examples.data2vec.models.modalities.base2 import (
    MaskSeed,
    D2vModalityConfig2,
    ModalitySpecificEncoder2,
    get_annealed_rate,
)
...
from examples.data2vec.models.modalities.audiotext import (
    D2vAudioTextConfig,
    AudioTextEncoder,
)
...
class D2vModalitiesConfig(FairseqDataclass):
    ...
    audiotext: D2vAudioTextConfig = D2vAudioTextConfig()
...
class Data2VecMultiModel(BaseFairseqModel):
    ...
    def __init__(self, cfg: Data2VecMultiConfig, modalities, skip_ema=False, task=None):
        ...
        """
        enc_audio_text = AudioTextencoder(
                D2vAudioConfig(),
                cfg.embed_dim,
                make_block,
                make_layer_norm,
        ...
        self.modality_encoders["audiotext"] = enc_audio_text
    ...
    def make_target_model(self):
        ...
        if self.cfg.ema_encoder_only:
            ...
            for mod_enc in model_copy.modality_encoders.values():
                mod_enc.audiodecoder = None
                mod_enc.textdecoder = None
