...
from eend.eend.pytorch_backend.eend_m2f.mask2former_model import EendM2F
...
def get_backbone_model(args) -> nn.Module:
    backbone = Backbone(
        ...
        downsample_type=args.backbone_downsample_typ,
        input_feat_dim=args.backbone_input_feat_dim,
...
def train(rank, world_size,args):
    ...
    # Prepare model
    batch_input = next(iter(train_set))
