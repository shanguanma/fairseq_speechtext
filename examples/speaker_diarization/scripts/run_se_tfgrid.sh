gpu=0,1,2,3
config_name=base_se_tfgrid
exp_name=baseline_se_min_tfgrid
other_args=
...
speech_encoder_path=/mnt/bn/junyi-nas2/codebase/joint-optimization/pretrained_models/pretrain.model # Speaker encoder path
...
fairseq-hydra-train \
  ...
  +model.speaker_encoder_path=${speech_encoder_path} \
  ${other_args}
