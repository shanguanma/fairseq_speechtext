...
if [ ${stage} -le 0 ]&&[ ${stop_stage} -ge 0 ];then
    ...
    infer_conf=$root_dir/fs_eend/config/spk_onl_tfm_enc_dec_nonautoreg_infer.yaml
    ...
    python train_diaxxx.py --configs $infer_conf --gpus 1 --test_from_folder $model_dir
