...
with open(f'/mlx_devbox/users/ajy/playground/mnt/bn/junyi-nas-hl2/datasets/jsalt2020_simulate/data/SimLibriCSS-{dataset}/mixspec.json') as f:
    ...
    for utt_info in tqdm(mix_info):
        ...
        for sub_utt_info in utt_info['inputs']:
            ...
            print(f'SPEAKER {utt_id} 1 {start} {duration} <NA> <NA> {spk_id} <NA> <NA>', file=rttm) 
