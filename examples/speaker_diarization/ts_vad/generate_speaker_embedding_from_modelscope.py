...
CAMPPLUS_VOX = {
    ...
    'obj': 'examples.speaker_diarization.ts_vad.models.modules.cam_pplus.CAMPPlus',
    'args': {
        'feat_dim': 80,
        'embedding_size': 512,
    },
...
ERes2Net_VOX = {
    ...
    'obj': 'examples.speaker_diarization.ts_vad.models.modules.ERes2Net.ERes2Net',
    'args': {
        'feat_dim': 80,
        'embedding_size': 192,
    },
...
ERes2Net_COMMON = {
    ...
    'obj': 'examples.speaker_diarization.ts_vad.models.modules.ERes2Net_huge.ERes2Net',
    'args': {
        'feat_dim': 80,
        'embedding_size': 192,
    },
...
EPACA_CNCeleb = {
    ...
    'obj': 'examples.speaker_diarization.ts_vad.models.modules.ECAPA_TDNN.ECAPA_TDNN',
    'args': {
        'input_size': 80,
        'lin_neurons': 192,
...
def main():
    ...
    def compute_embedding(wav_file, save=True):
        ...
        if save:
            ...
            dest_dir=os.path.join(embedding_dir,os.path.dirname(wav_file).split("/")[-1])
            dest_dir = pathlib.Path(dest_dir)
            dest_dir.mkdir(exist_ok=True, parents=True)
            embedding_name=os.path.basename(wav_file).rsplit('.',1)[0]
