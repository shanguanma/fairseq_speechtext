...
class W2lDecoder(object):
    ...
    def get_frame_tokens(self, idxs):
        """ get ctc frame level output tokens"""
        return torch.LongTensor(list(idxs))
...
class W2lViterbiFrameDecoder(W2lDecoder):
    def __init__(self, args, tgt_dict):
        super().__init__(args, tgt_dict)
    ...
    def decode(self, emissions):
        ...
        return [
            [{"tokens": self.get_frame_tokens(viterbi_path[b].tolist()), "score": 0}]
            for b in range(B)
        ]
