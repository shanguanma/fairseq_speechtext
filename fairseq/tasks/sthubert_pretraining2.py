...
from fairseq.data import Dictionary, StHubertDataset2, HubertDataset
...
@register_task("sthubert_pretraining2", dataclass=StHubertPretrainingConfig2)
class StHubertPretrainingTask2(FairseqTask):
    cfg: StHubertPretrainingConfig2
    ...
    @classmethod
    def setup_task(
        cls, cfg: StHubertPretrainingConfig2, **kwargs
