...
class Voicelm2Config(HubertConfig2):
    ...
    ## fusion related part
    audio_feature_type: str = field(default='cnn', metadata={'help': 'audio feature extractor: cnn layes or fbank layer:'})
    modality_fuse: str = field(default='attention', metadata={'help': 'fusing two modalities: cross self-attention'})
...
class Voicelm2Model(BaseFairseqModel):
    def __init__(
        ...
        elif cfg.audio_feature_type=='fbank': ### torchaudio fbank not support batch process
            pass
    ...
    def forward_audio_targets(
        self, features: torch.Tensor, #mask_indices: torch.Tensor,
