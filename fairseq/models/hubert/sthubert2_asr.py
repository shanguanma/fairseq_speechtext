...
@dataclass
class StHubertAsrConfig2(FairseqDataclass):
...
@dataclass
class StHubertCtcConfig2(StHubertAsrConfig2):
    pass


@register_model("sthubert2_ctc", dataclass=StHubertCtcConfig2)
class HubertCtc(BaseFairseqModel):
    def __init__(self, cfg: StHubertCtcConfig2, w2v_encoder: BaseFairseqModel):
        super().__init__()
        self.cfg = cfg
    ...
    @classmethod
    def build_model(cls, cfg: StHubertCtcConfig2, task: FairseqTask):
...
class StHubertEncoder2(FairseqEncoder):
    def __init__(self, cfg: StHubertAsrConfig2, task):
