...
@dataclass
class HubertConfig2(FairseqDataclass):
...
### compared hubert.py,  hubert2.py 1.add more choices for ConvFeatureExtractionModel,
###                                 2.  TransformerEncoder support related position encoding               
@register_model("hubert2", dataclass=HubertConfig2)
class HubertModel2(BaseFairseqModel):
    def __init__(
        ...
        super().__init__()
        logger.info(f"HubertModel2 Config: {cfg}")
    ...
    @classmethod
    def build_model(cls, cfg: HubertConfig2, task: HubertPretrainingTask):
        """Build a new model instance."""

        model = HubertModel2(cfg, task.cfg, task.dictionaries)
        return model
